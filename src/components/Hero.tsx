...
const Hero = () => {
    ...
    return (
        <section className="w-full h-[87.5vh] flex flex-col items-center justify-center text-center"
            ...
            <h1 className="text-7xl font-bold text-white text-shadow-background-a text-shadow-lg md:text-9xl">
                Dylan Buchanan
            </h1>
            ...
            <button onClick={DownloadCV} className="cursor-pointer rounded-md bg-background-a p-1 px-2 mt-4 hover:bg-background-a-light hover:scale-110 transition-transform duration-300">Download CV</button>
        </section>
    );
};
